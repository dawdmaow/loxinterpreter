import std/[os, osproc, strformat, strutils, terminal]
...
for file in walkDirRec("."):
  ...
  let (output, err) =
    execCmdEx(&"nim --verbosity:0 --hints:off --warnings:off r {file}")
  styledEcho output
